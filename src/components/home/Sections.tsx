    ...
    <section id="projects" className="relative overflow-hidden bg-background py-24 lg:py-36">
      ...
      <div className="shell relative z-10 grid gap-16 lg:grid-cols-2 lg:gap-24">
        ...
        <div>
          ...
          <Reveal delay={0.12}>
            <p className="body-secondary mt-6 max-w-xl">{project.body}</p>
          </Reveal>
      ...
      <div className="shell py-24 lg:py-36">
        ...
        <Reveal delay={0.08}>
          <p className="lede mt-8 max-w-2xl">
            Feedback from the housing administrators, estates directors, and student accommodation
            teams who experience our operations daily across campuses.
          </p>
        </Reveal>
...
export function CtaBand() {
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-background text-white border-t border-hairline"
    >
                ...
                <div className="mt-8 space-y-4 border-t border-white/5 pt-6">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-white group-hover:text-active transition-colors">
                        {company.tel}
                      </p>
                    </div>
                  </a>
            ...
            <div className="flex flex-col justify-between h-full bg-[#121217] p-8 rounded-xl border border-hairline gold-glow">
              <div>
                ...
                <p className="mt-4 text-base text-muted-foreground leading-relaxed">
                  Our administrative and management teams are available during standard working
                  hours for support, meetings, and planned maintenance coordination.
                </p>
              ...
              <div className="mt-8 border-t border-white/10 pt-6">
                ...
                <p className="mt-2.5 text-xs text-muted-foreground">
                  A staffed helpdesk and emergency response team remains active 24/7/365 to handle
                  any immediate residential or accommodation infrastructure issues.
                </p>
              </div>
            </div>
          </Reveal>
